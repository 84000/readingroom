...
/**
 * 
 * This is the top-level class for actually viewing a text
 * 
 * @author curtis
 *
 */
public class Reader extends Composite {
	...
	public void Initialize(String textId, String pageName, BreadCrumb bc)
	{
		...
		{
			// Set bread-crumb (shows while text is loading)
			...
			// "Process" (lots of parsing, HTML substitution, etc.) the given text
	...
	{
		return textDeckPanel.getWidgetCount();
	}
	...
	// The server calls cascade from the initial call-back (from the processText() call above)
	//
