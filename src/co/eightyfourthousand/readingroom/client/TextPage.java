...
/**
 * 
 * A panel representing an individual "page" within a text (e.g., the Summary, a Chapter, etc.)
 * 
 * @author curtis
 *
 */
	...
	public void setTitleData(TextItem tItem)
	{
		...
		downloadButton.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				GATracker.trackPageview("/" + "download-request/" + tId);
				
				// TEMPORARILY DISABLE PDF-CONVERSION FOR NORMAL USERS
				if (User.isAdmin() || User.isDev() || 
					tId.equals("UT22084-044-005") || tId.equals("UT22084-044-006") || tId.equals("UT22084-055-004") ||
					tId.equals("UT22084-054-003") || tId.equals("UT22084-056-002") || tId.equals("UT22084-061-006") || tId.equals("UT22084-062-012"))
				{
					GATracker.trackPageview("/" + "download/" + tId);
