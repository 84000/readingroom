...
import co.eightyfourthousand.readingroom.client.ReadingRoomService;
import co.eightyfourthousand.readingroom.shared.Global;
import co.eightyfourthousand.readingroom.shared.PartName;
import co.eightyfourthousand.readingroom.shared.QueryVerifier;
...
public class ReadingRoomServiceImpl extends RemoteServiceServlet implements ReadingRoomService
{
	...
	public String doQuery(String queryName, String[] args)
	{
		...
		{
		if (args[0] != null)
			System.out.println("FOLDER BEING QUERIED: " + args[0]);
		else
